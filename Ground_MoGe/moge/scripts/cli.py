...
def main():
    from moge.scripts import app, infer, infer_baseline, infer_panorama, eval_baseline, eval_baselinelora, vis_data
    ...
    cli.add_command(eval_baselinelora.main, name='eval_baseline_lora')
