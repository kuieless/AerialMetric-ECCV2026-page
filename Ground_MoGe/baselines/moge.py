...
class Baseline(MGEBaselineInterface):
    ...
    def __init__(
        ...
        self.model = MoGeModel.from_pretrained(model_source).to(device).eval()
    ...
    @click.option('--checkpoint', 'checkpoint_path', type=click.Path(), default='', help='Optional local checkpoint path. If set, load this checkpoint instead of --pretrained.')
