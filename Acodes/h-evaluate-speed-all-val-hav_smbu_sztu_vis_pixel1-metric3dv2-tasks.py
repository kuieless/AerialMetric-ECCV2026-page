...
TASKS = [
    ...
    {
        "task_name": "Metrc3dv2-Large-Absolute",
        "output_file": "/home/data1/szq/Megadepth/metric3D/D1/infer6/Infer-l-17k.txt",
        "use_median_scaling": False,  # 关闭定标
        "paths": PATHS_Metric3dv2_Large     # 使用上面定义的第一组列表
    },

    # --- 任务 B: Moge2 Large (有定标 / 相对尺度) ---
    {
        "task_name": "Metrc3dv2-Large-MedianScaling",
        "output_file": "/home/data1/szq/Megadepth/metric3D/D1/infer6/Infer-l-17k-MS.txt",
        "use_median_scaling": True,   # 开启定标
        "paths": PATHS_Metric3dv2_Large     # 复用同一组数据，只是参数不同
    },


    # {
    #     "task_name": "Metrc3dv2-Giant-Absolute",
    #     "output_file": "/home/data1/szq/Megadepth/metric3D/D1/infer2/Infer-b.txt",
    #     "use_median_scaling": False,  # 关闭定标
    #     "paths": PATHS_Metric3dv2_Giant     # 使用上面定义的第一组列表
    # },

    # # --- 任务 B: Moge2 Large (有定标 / 相对尺度) ---
    # {
    #     "task_name": "Metrc3dv2-Giant-MedianScaling",
    #     "output_file": "/home/data1/szq/Megadepth/metric3D/D1/infer2/Infer-b-MS.txt",
    #     "use_median_scaling": True,   # 开启定标
    #     "paths": PATHS_Metric3dv2_Giant     # 复用同一组数据，只是参数不同
    # },


    # {
    #     "task_name": "Metrc3dv2-SMALL-Absolute",
    #     "output_file": "/home/data1/szq/Megadepth/metric3D/D1/infer2/Infer-s.txt",
    #     "use_median_scaling": False,  # 关闭定标
    #     "paths": PATHS_Metric3dv2_SMALL     # 使用上面定义的第一组列表
    # },

    # # --- 任务 B: Moge2 Large (有定标 / 相对尺度) ---
    # {
    #     "task_name": "Metrc3dv2-SMALL-MedianScaling",
    #     "output_file": "/home/data1/szq/Megadepth/metric3D/D1/infer2/Infer-s-MS.txt",
    #     "use_median_scaling": True,   # 开启定标
    #     "paths": PATHS_Metric3dv2_SMALL     # 复用同一组数据，只是参数不同
    # },
