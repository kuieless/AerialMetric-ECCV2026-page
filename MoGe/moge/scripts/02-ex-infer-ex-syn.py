...
# 1. 输入根目录 (你的推理结果输出目录)
BASE_INPUT_DIR = "/home/data1/szq/Megadepth/Aerial_lifting_early/dji/process_lidar_mesh_szq/syn-process/Test-data-results-4.5k"

# 2. 输出根目录 (提取出来的 npy 存放地)
BASE_OUTPUT_DIR = "/home/data1/szq/Megadepth/Aerial_lifting_early/dji/process_lidar_mesh_szq/syn-process/Test-data-results-4.5k-out"
