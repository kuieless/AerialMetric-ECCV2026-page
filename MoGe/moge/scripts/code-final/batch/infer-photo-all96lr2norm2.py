...
TASK_A_OUTPUT_DIR = "/data1/szq/Infer-Final/Table2-1/Table2-head-LoRA-96-groundless4-UElr2-norm3"
TASK_A_DATASETS = [
    # "/data1/szq/Val/Bench",
...
TASK_B_OUTPUT_DIR = "/data1/szq/Table2-head-LoRA-96-Ground-groundless4-UElr2-norm3"
TASK_B_USE_ORACLE = True     # 🔥 新增：是否开启 oracle 模式（读取真实内参）
# TASK_B_BASELINE_SCRIPT = "/home/szq/moge2/MoGe/moge/scripts/eval_baseline_lora96-norm.py"
TASK_B_EVAL_SCRIPT_REL = "/home/szq/moge2/MoGe/moge/scripts/eval_baseline_lora96-norm.py"
        ...
        if has_files:
            ...
            try:
                run_cmd([
                    ...
                    "--resize", "0",
                    "--batch_size", "1"  # <--- 🚀 加上这个参数，8或者16，看你的显存能不能撑住
...
def process_single_ckpt_task_b(ckpt_path):
    ...
    try:
        ...
        # 🔥 如果开启了 Oracle 模式，就把标签 append 进去
