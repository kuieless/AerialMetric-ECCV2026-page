...
CHECKPOINT_ROOT = "/data1/szq/workspace/lora-batch96-192-with-UElr2-aerial-UE/checkpoint"
EVAL_STEP_INTERVAL = 300      # 【核心】每隔多少步评估一次？设为 100 表示只跑 0, 100, 200... (设为 None 或 0 则关闭间隔筛选)
...
TASK_A_OUTPUT_DIR = "/data1/szq/Infer-Final/Table2-1/Table2-head-LoRA-96-groundless4-UElr2-aerial-UE"
TASK_A_DATASETS = [
    "/data1/szq/Val/Bench",
...
TASK_B_OUTPUT_DIR = "/data1/szq/Table2-head-LoRA-96-Ground-groundless4-UElr2-aerial-UE"
...
# --- 任务 C: 绘图配置 ---
PLOT_ENABLE = True    
PLOT_SAVE_PREFIX = "final_lora96-groundless4-UElr2-aerial-UE" 
