...
# 1. 权重根目录
CHECKPOINT_ROOT = "/data1/szq/workspace/lora-batch32-64-lessground4-with-UE/checkpoint"
...
TASK_A_OUTPUT_DIR = "/data1/szq/Infer-Final/Table2-1/Table2-head-LoRA-32-groundless4-UE"
TASK_A_DATASETS = [
    "/data1/szq/Val/Bench",
...
TASK_B_OUTPUT_DIR = "/data1/szq/Table2-head-LoRA-32-Ground-groundless4-UE"
...
# --- 任务 C: 绘图配置 ---
PLOT_ENABLE = True    
PLOT_SAVE_PREFIX = "final_lora32-groundless4-UE" 
...
def process_single_ckpt_task_a(ckpt_path):
    ...
    for dataset_path in TASK_A_DATASETS:
        ...
        if has_files:
            ...
            try:
                run_cmd([
                    "python", "a-infer_lora32.py", # ⚠️ 依循原代码使用 a-infer_lora.py，如果有误可改为 a-infer_lora32.py
                    "--input", dataset_path,
                    "--output", infer_out,
