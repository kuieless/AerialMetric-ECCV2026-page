...
import argparse
import cv2
parser = argparse.ArgumentParser(description="Step 3: Evaluation")
parser.add_argument("--pred_root", type=str, required=True, help="预测结果目录 (Step 2 的输出)")
...
_RURAL_LIST = [
    ...
    "R-PHD-output", "ODM1-output", "ODM2-output", 
...
_NATURAL_LIST = [
    ...
    "park8", "park9", "interval5_AMvalley03_cropped_downsampled", "ODM6-output"
]
