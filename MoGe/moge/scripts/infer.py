...
python /home/data1/szq/Megadepth/benchmarkmodel/Moge2/MoGe/moge/scripts/infer.py -i /home/data1/szq/Megadepth/metric3D/D1/Metric3D/GES-Test3-down/images/images_downsampled -o /home/data1/szq/Megadepth/metric3D/D1/Metric3D/GES-Test3-down-Moge2 --pretrained /home/data1/szq/Megadepth/benchmarkmodel/Moge2/MoGe/model.pt --version v2 --maps
'''
...
# ✅ [新增] 采样步长参数
@click.option('--stride', type=int, default=1, help='Sampling stride. 1 means all images, 10 means 10%.')
...
def main(
    ...
    # ✅ [新增] 采样逻辑：支持百分比采样，且保证至少跑一张
    original_count = len(image_paths)
    if stride > 1:
        image_paths = image_paths[::stride]
        print(f"📉 采样模式开启: 步长={stride}, 数量从 {original_count} 减少到 {len(image_paths)} (至少保留1张)")
...
'''
python /home/szq/moge2/MoGe/moge/scripts/infer.py -i /home/szq/moge2/MoGe/workspace/final-fintune2-130-lora-final4/vis/step_00003000/0017/image -o /home/szq/moge2/MoGe/workspace/final-fintune2-130-lora-final4/vis/step_00003000/0017/image-output --pretrained /home/szq/moge2/MoGe/vitl-normal.pt --version v2
