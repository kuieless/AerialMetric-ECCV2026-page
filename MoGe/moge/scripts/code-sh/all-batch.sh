...
run_all_tasks() {
    ...
    # === 任务 1 ===
    run_pipeline "Val-Results-moge2-Parallel-normal3-1000222" \
                 "/home/szq/moge2/MoGe/vitl-normal.pt"

    # === 任务 2 (示例) ===
    run_pipeline "Val-Results-moge2-500step-neck" \
                 "/home/szq/moge2/MoGe/workspace/final-fintune-scalehead-neck/checkpoint/00000500.pt"

    # === 任务 3 (示例) ===
    # run_pipeline "Exp_Name_3" "/path/to/model_3.pt"
}
