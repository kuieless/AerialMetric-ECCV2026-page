...
#  CUDA_VISIBLE_DEVICES=6
    ...
    run_pipeline "Val-Results-130lora3-64-500s1" \
                 "/home/szq/moge2/MoGe/workspace/final-fintune2-130-lora-final6-64r/checkpoint/00002000.pt"
...
run_pipeline() {
   ...
   echo -e "\n▶️ [1/3] Step 1: 启动并行推理 ($NUM_WORKERS 进程)..."
    ...
    # 🔥🔥🔥 这里的路径请根据你实际的 Config 路径修改 🔥🔥🔥
    # 比如: /home/szq/moge2/MoGe/configs/Final_train/train-l-patch.json
    CONFIG_PATH="/home/szq/moge2/MoGe/configs/Final_train/train-l-patch-lora.json"

    for ((i=0; i<NUM_WORKERS; i++)); do
        # ⚠️ 注意：请确认这里指向的是你刚刚保存的【LoRA版】批量脚本
        $PYTHON_CMD /home/szq/moge2/MoGe/moge/scripts/a-infer_batch_Real-final-batch-lora.py \
            --config "$CONFIG_PATH" \
